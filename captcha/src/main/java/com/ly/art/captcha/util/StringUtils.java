package com.ly.art.captcha.util;
...
public class StringUtils {
     ...
     * @deprecated Use the clearer named {@link #trimToEmpty(String)}. Method will be removed in
     *             Commons Lang 3.0.
     */
    ...
    /**
     * <p>
     * Strips whitespace from the start and end of a String returning <code>null</code> if the
     ...
     * </p>
     * <p>
     * A <code>null</code> input String returns <code>null</code>. An empty string ("") input
     ...
     * @return the first index of the search character, -1 if no match or <code>null</code> string
     *         input
     * @since 2.0
     */
    ...
    /**
     * <p>
     * Finds the first index within a String from a start position, handling <code>null</code>. This
     * method uses {@link String#indexOf(int, int)}.
     * </p>
     * <p>
     * A <code>null</code> or empty ("") String will return <code>(INDEX_NOT_FOUND) -1</code>. A
     ...
     * @return the first index of the search String, -1 if no match or <code>null</code> string
     *         input
     * @since 2.0
     */
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>-1</code>. A negative start position is treated
     * as zero. An empty ("") search String always matches. A start position greater than the string
     * length only matches an empty search String.
     * </p>
     *
     * <pre>
     * StringUtils.indexOf(null, *, *)          = -1
     ...
     * @param str the String to check, may be null
     * @param searchChar the character to find
     * @return the last index of the search character, -1 if no match or <code>null</code> string
     *         input
     * @since 2.0
     */
    ...
    /**
     * <p>
     * Finds the last index within a String from a start position, handling <code>null</code>. This
     * method uses {@link String#lastIndexOf(int, int)}.
     * </p>
     * <p>
     * A <code>null</code> or empty ("") String will return <code>-1</code>. A negative start
     * position returns <code>-1</code>. A start position greater than the string length searches
     * the whole string.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>-1</code>. A negative start position returns
     * <code>-1</code>. An empty ("") search String always matches unless the start position is
     ...
     * @param str the String to check, may be null
     * @param searchChar the character to find
     * @return true if the String contains the search character, false if not or <code>null</code>
     *         string input
     * @since 2.0
     */
     ...
     * @param str the String to check, may be null
     * @param searchStr the String to find, may be null
     * @return true if the String contains the search String, false if not or <code>null</code>
     *         string input
     * @since 2.0
     */
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>-1</code>. A <code>null</code> or zero length
     * search array will return <code>-1</code>. A <code>null</code> search array entry will be
     * ignored, but a search array containing "" will return <code>0</code> if <code>str</code> is
     * not null. This method uses {@link String#indexOf(String)}.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * A <code>null</code> String will return <code>-1</code>. A <code>null</code> search array will
     * return <code>-1</code>. A <code>null</code> or zero length search array entry will be
     * ignored, but a search array containing "" will return the length of <code>str</code> if
     ...
     * </p>
     * <p>
     * A negative start position can be used to start <code>n</code> characters from the end of the
     * String.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * A negative start position can be used to start/end <code>n</code> characters from the end of
     * the String.
     * </p>
     * <p>
     * The returned substring starts with the character in the <code>start</code> position and ends
     * before the <code>end</code> position. All position counting is zero-based -- i.e., to start
     * at the beginning of the string use <code>start = 0</code>. Negative start and end positions
     ...
     * </p>
     * <p>
     * If <code>len</code> characters are not available, or the String is <code>null</code>, the
     ...
     * </p>
     * <p>
     * A <code>null</code> string input will return <code>null</code>. An empty ("") string input
     ...
     * <p>
     * A <code>null</code> string input will return <code>null</code>. An empty ("") string input
     * will return the empty string. A <code>null</code> separator will return the empty string if
     ...
     * </p>
     * <p>
     * A <code>null</code> input String returns <code>null</code>. A <code>null</code> tag returns
     * <code>null</code>.
     * </p>
     *
     * <pre>
     ...
     * </p>
     * <p>
     * A <code>null</code> input String returns <code>null</code>. A <code>null</code> open/close
